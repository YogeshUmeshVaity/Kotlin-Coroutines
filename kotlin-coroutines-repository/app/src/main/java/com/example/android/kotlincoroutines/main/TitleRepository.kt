 ...
 * Important:The extension await defined here is a good way to bridge an existing API to
 * coroutines. However, it relies upon the caller remembering to call await. When designing new
 * APIs for use in Kotlin, it is better to provide results directly through suspend functions.
 * For example: suspend fun fetchNewWelcome: String
 * If fetchNewWelcome were redefined as a suspend function like this callers wouldn't need to
 * remember to call await every time they used it.
 *
